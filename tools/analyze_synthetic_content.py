...
from synthetic_content import (
    is_placeholder_synonym,
    is_template_collocation,
    is_template_english_def,
    is_template_example,
    is_template_memory_tips,
    word_has_synthetic_content,
)
...
def analyze_word(word: dict, stats: BookStats) -> bool:
    has_synthetic = word_has_synthetic_content(word)
